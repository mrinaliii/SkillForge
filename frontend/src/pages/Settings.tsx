...
import { User, Bell, Palette, Link2, Database, LogOut, Upload } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm opacity-60">Get notified about skills that need practice</p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm opacity-60">Get reminded to maintain your streak</p>
            </div>
            <button
          ...
          <div>
            <label className="block font-medium mb-2">
              Alert when retention drops below: <span className="font-bold">{retentionThreshold}%</span>
            </label>
            <input
              type="range"
              min="30"
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            <label className="block font-medium mb-2">
              Decay Sensitivity: <span className="font-bold">{decaySensitivity > 65 ? 'Aggressive' : decaySensitivity > 35 ? 'Normal' : 'Relaxed'}</span>
            </label>
            <input
              type="range"
              min="0"
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="w-4 h-4 rounded-full" style={{ backgroundColor: '#291d77' }} />
                </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="w-4 h-4 rounded-full" style={{ backgroundColor: '#9488e2' }} />
                </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-60">Track skills from your repositories</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-60">Sync skills with your profile</p>
              </div>
            </div>
            <span className="px-3 py-1 rounded-full text-xs font-medium"
              style={{ backgroundColor: 'var(--warning)' + '20', color: 'var(--warning)' }}
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <button
            className="w-full p-4 rounded-lg border text-left transition-all hover:scale-102"
            style={{ backgroundColor: 'var(--danger)' + '10', borderColor: 'var(--danger)' }}
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium" style={{ color: 'var(--danger)' }}>Delete Account</p>
                <p className="text-sm opacity-60">Permanently delete your account and all data</p>
              </div>
